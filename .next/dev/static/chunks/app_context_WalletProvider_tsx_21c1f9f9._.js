...
const WalletContextProvider = ({ children })=>{
    ...
    const endpoint = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WalletContextProvider.useMemo[endpoint]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clusterApiUrl"])("devnet")
    ...
    const onError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WalletContextProvider.useCallback[onError]": (error)=>{
            ...
            if (error.name === "WalletConnectionError" || error.message?.includes("Unexpected error") || error.message?.includes("User rejected")) {
...
_s(WalletContextProvider, "d0lP12HGMx9seVZpfPNa1u9wI+8=");
